...
-- ─── Стартовые данные ────────────────────────────────────────
insert into public.categories (slug, name, description, image_url, h1, seo_title, seo_description, sort_order) values
  ('vanny', 'Ванны', 'Акриловые и стальные ванны Grohe, AM.PM, Cersanit. Подбор, доставка и установка.', '/photos/showroom-3.jpg',
   ...
   'Акриловые ванны в Астане по цене от 35 000 ₸. Оптом и в розницу, доставка по Казахстану, гарантия до 5 лет.', 10),
  ('rakoviny', 'Раковины', 'Раковины на пьедестале, накладные и тумбы с раковиной.', '/photos/rakoviny.jpeg',
   ...
   'Раковины, тумбы с раковиной и раковины на пьедестале в Астане от 25 000 ₸. Опт и розница, доставка по РК.', 20),
  ('unitazy', 'Унитазы', 'Напольные и подвесные унитазы, компакты и безободковые модели.', '/photos/unitazy.jpg',
   ...
   'Унитазы в Астане от 25 000 ₸: подвесные, напольные, безободковые. Оптом для застройщиков, доставка по Казахстану.', 30),
  ('smesiteli', 'Смесители', 'Смесители для ванны, раковины и кухни, душевые системы.', null,
   ...
   'Смесители Grohe, AM.PM, Frap в Астане. Гарантия до 5 лет, оптовые цены от 10 штук.', 40),
  ('installyacii', 'Инсталляции', 'Инсталляции для подвесных унитазов и кнопки смыва.', null,
   ...
   'Инсталляции для подвесных унитазов в Астане: комплекты с кнопкой смыва, опт и розница, доставка на объект.', 50)
