...
4. **SEO** — `NEXT_PUBLIC_SITE_URL=https://sanlux.kz`; коды подтверждения Google Search Console и Яндекс.Вебмастера — в `NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION` / `NEXT_PUBLIC_YANDEX_VERIFICATION`.
